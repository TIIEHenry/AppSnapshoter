 ...
 * 一个线程读一个线程写，速度超快
 */
public class StreamParallelTransformer {
    ...
    public StreamParallelTransformer(final InputStream inputStream, final OutputStream outputStream) {
        this(inputStream, outputStream, 5);
    }

    public StreamParallelTransformer(final InputStream inputStream, final OutputStream outputStream, int dataItemCount) {
        this.finished = false;
        this.exception = null;
