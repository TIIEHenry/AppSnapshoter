...
import tiieherny.android.app.snapshotor.group.SelectAppFragment
import tiieherny.android.app.snapshotor.group.SnapGroup
import tiieherny.android.app.snapshotor.databinding.ItemGroupBinding
import tiieherny.android.app.snapshotor.group.SnapedApp
import tiieherny.android.app.snapshotor.ui.group.GroupConfigFragment
...
class GroupsAdapter(
    ...
    class GroupViewHolder(
        ...
        private fun showDeleteConfirmDialog(group: SnapGroup) {
            val context = binding.root.context
            AlertDialog.Builder(context)
                .setTitle("删除组")
                .setMessage(group.name+"["+group.id+"]")
                .setPositiveButton(android.R.string.ok) { _, _ ->
                    SnapShotApp.getViewModel().deleteGroup(group.id)
                }
        ...
        private fun applySorting(apps: List<SnapedApp>, sortConfig: tiieherny.android.app.snapshotor.config.SortConfig): List<SnapedApp> {
