...
import tiiehenry.android.app.snapshotor.app.AppTag
        ...
        return apps.filter { appInfo ->
            ...
            if (groupsToCheck.isEmpty()) {
                ...
                builtinMatch && groupsToCheck.all { group ->
                    ...
                    val fs = tiiehenry.android.app.snapshotor.SnapShotApp.getInstance().fileSystem
                    val appDir = "${group.path}/${appInfo.packageName}"
                    fs.fileType(appDir) == tiiehenry.android.snapshotor.fs.IFileType.TYPE_DIR
                }
            }
        }
    }
