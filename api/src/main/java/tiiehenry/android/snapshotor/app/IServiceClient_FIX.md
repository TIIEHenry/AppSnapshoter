...
- `api/src/main/java/tiiehenry/android/snapshotor/app/IServiceClient.java` - 核心修复文件
- `provider-appmanager/src/main/java/tiiehenry/android/snapshotor/provider/appmanager/root/SnapShotRootServiceClient.java` - RootService 客户端实现
