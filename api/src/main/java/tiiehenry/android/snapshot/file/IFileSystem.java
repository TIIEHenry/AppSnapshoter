...
public interface IFileSystem {
    ...
    void createTarArchive(String sourceDir, String targetFile, List<String> excludes, List<String> excludeFiles, String stdErr, String stdOut);

    void createTarArchiveForMultiple(List<String> files, String targetFile, String stdErr, String stdOut);
